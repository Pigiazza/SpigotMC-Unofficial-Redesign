...
export function SimpleHeader({active}:{active:"forums"|"resources"}) {
  ...
  return <header className="sub-header glass">
    ...
    <nav className={open?"sub-nav open":"sub-nav"}><a href="/">Home</a><a className={active==="forums"?"active":""} href="/forums">Forum</a><a className={active==="resources"?"active":""} href="/resources">Risorse</a><a href="https://www.spigotmc.org/wiki/">Wiki</a></nav>

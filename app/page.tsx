...
const copy = {
  en: {
    ...
    community: "COMMUNITY", meet: "Where builders meet.", communityText: "Questions, discoveries, and ideas from the people shaping Minecraft servers.", all: "View all discussions", idea: "Your next big idea starts here.", ideaText: "Join millions of server owners, developers, and creators sharing what they know.", account: "Create free account", noCard: "No credit card. Just Minecraft.", disclaimer: "An independent redesign proposal. Not affiliated with or endorsed by SpigotMC.", footer: ["About", "Privacy", "Contact"]
  },
  it: {
    ...
    community: "COMMUNITY", meet: "Dove i creator si incontrano.", communityText: "Domande, scoperte e idee dalle persone che stanno plasmando i server Minecraft.", all: "Vedi tutte le discussioni", idea: "La tua prossima grande idea inizia qui.", ideaText: "Unisciti a milioni di proprietari, sviluppatori e creator che condividono ciò che sanno.", account: "Crea un account gratis", noCard: "Nessuna carta. Solo Minecraft.", disclaimer: "Una proposta di redesign indipendente. Non affiliata né approvata da SpigotMC.", footer: ["Chi siamo", "Privacy", "Contatti"]
  }
} as const;
